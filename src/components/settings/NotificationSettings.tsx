        ...
        {items.map((item) => (
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center text-white/40 group-hover:text-[#c7c42a] transition-colors">
                <item.icon size={20} />
              </div>
              <div>
            ...
            <button 
              ...
              className={`relative w-14 h-8 rounded-full transition-all duration-300 ${
                prefs[item.key as keyof typeof prefs] ? 'bg-[#c7c42a]' : 'bg-white/10'
              }`}
            >
