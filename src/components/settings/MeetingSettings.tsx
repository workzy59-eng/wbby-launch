        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] space-y-6">
            ...
            <select 
              ...
              className="w-full bg-black/40 border border-white/10 rounded-2xl py-4 px-6 text-white text-sm outline-none focus:border-[#c7c42a]/50 transition-all appearance-none"
            >
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <button 
                  ...
                  className={`relative w-12 h-6 rounded-full transition-all ${adminData.reminders.oneHour ? 'bg-[#c7c42a]' : 'bg-white/10'}`}
                >
              ...
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <button 
                  ...
                  className={`relative w-12 h-6 rounded-full transition-all ${adminData.reminders.tenMinutes ? 'bg-[#c7c42a]' : 'bg-white/10'}`}
                >
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <button 
                  ...
                  className={`relative w-12 h-6 rounded-full transition-all ${adminData.allowRescheduling ? 'bg-[#c7c42a]' : 'bg-white/10'}`}
                >
              ...
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <button 
                  ...
                  className={`relative w-12 h-6 rounded-full transition-all ${adminData.allowClientRequests ? 'bg-[#c7c42a]' : 'bg-white/10'}`}
                >
        ...
        <div className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] space-y-6">
          ...
          <label className="flex items-center justify-between cursor-pointer group">
            ...
            <button 
              ...
              className={`relative w-12 h-6 rounded-full transition-all ${clientData.enableReminders ? 'bg-[#c7c42a]' : 'bg-white/10'}`}
            >
