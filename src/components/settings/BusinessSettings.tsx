    ...
    <div className="space-y-10">
      <div className="flex flex-col sm:flex-row items-center gap-8">
        <div className="relative group">
          <div className="w-40 h-40 rounded-[2.5rem] overflow-hidden bg-white/5 border-2 border-white/10 group-hover:border-[#E6FF00]/50 transition-all flex items-center justify-center">
            {formData.logo ? (
              <img 
                src={formData.logo} 
                alt="Business Logo" 
