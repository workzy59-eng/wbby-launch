            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-widest text-white/40 ml-4">UPI ID</label>
                <input 
                  ...
                  className="w-full bg-black/40 border border-white/10 rounded-2xl py-4 px-6 text-white text-sm outline-none focus:border-[#cfcb11]/50 transition-all"
    ...
    <div className="space-y-8">
      <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-8 space-y-6">
        <div className="flex items-center justify-between">
          ...
          <span className="px-4 py-2 bg-[#cfcb11] text-black rounded-full text-[10px] font-black uppercase tracking-widest">
