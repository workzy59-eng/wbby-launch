    ...
    <div className="min-h-screen bg-black text-white selection:bg-[#E6FF00] selection:text-black">
      ...
      <div className="max-w-7xl mx-auto pt-40 pb-20 px-10 flex flex-col lg:flex-row gap-16">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-12 pr-4 text-xs font-bold uppercase tracking-widest outline-none focus:border-[#E6FF00]/50 transition-all"
              />
            </div>
          </div>
        ...
        <main className="flex-1 space-y-16">
              ...
              <div className="space-y-12">
                {DOCS_CONTENT[activeSection as keyof typeof DOCS_CONTENT].sections.map((section, i) => (
                  <div key={i} className="space-y-6 group">
                    <h3 className="text-2xl font-black uppercase italic tracking-tighter text-white group-hover:text-[#E6FF00] transition-colors">
                      {section.subtitle}
                    </h3>
          ...
          {/* CTA */}
          <section className="bg-[#E6FF00] rounded-[3rem] p-12 text-black space-y-8 relative overflow-hidden">
