...
export default function About() {
  return (
    <div className="pt-40 pb-20 px-10">
      <SEO title="About WebbyLaunch – Expert Website Developers in India" />
      <div className="max-w-7xl mx-auto">
        <div className="text-center space-y-6 mb-20">
          ...
          <p className="max-w-2xl mx-auto text-white/60 text-lg font-medium leading-relaxed">
            WebbyLaunch is a premium web development agency based in India, dedicated to helping small businesses and startups establish a powerful online presence in record time.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center mb-32">
          ...
          <div className="aspect-square bg-white/5 rounded-[3rem] border border-white/10 overflow-hidden">
            <img 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={idx} className="bg-white/5 border border-white/10 p-10 rounded-[2.5rem] space-y-6">
              <div className="w-12 h-12 bg-[#E6FF00] rounded-xl flex items-center justify-center text-black">
                <item.icon size={24} />
              </div>
