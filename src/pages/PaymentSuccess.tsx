...
export default function PaymentSuccess() {
  ...
  return (
    <div className="min-h-screen bg-black pt-40 pb-20 px-10 font-sans overflow-hidden relative">
      ...
      {/* Background Accents */}
      <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#c7c42a]/10 blur-[120px] rounded-full" />
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="w-32 h-32 bg-[#c7c42a] rounded-full flex items-center justify-center mx-auto mb-8 shadow-[0_0_50px_rgba(199, 196, 42,0.4)]"
          >
          ...
          <div className="space-y-4">
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase italic leading-none">
              Payment <span className="text-[#c7c42a]">Received!</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            {[
              { icon: <ShieldCheck className="text-[#c7c42a]" />, title: 'Verified', desc: 'Payment confirmed' },
              { icon: <Clock className="text-[#c7c42a]" />, title: 'Review', desc: '48h expert analysis' },
              { icon: <Rocket className="text-[#c7c42a]" />, title: 'Launch', desc: 'Fast deployment' }
            ].map((item, i) => (
          ...
          <div className="space-y-6 pt-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/dashboard"
                className="bg-[#c7c42a] text-black px-10 py-6 rounded-full font-black text-xl uppercase italic flex items-center justify-center gap-3 hover:scale-105 transition-all shadow-[0_0_30px_rgba(199, 196, 42,0.2)]"
              >
