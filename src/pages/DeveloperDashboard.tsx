  ...
  if (showOnboarding) {
    return (
      <div className="min-h-screen bg-[#4A5D4E] flex items-center justify-center p-6 font-sans">
        ...
        >
          <div className="absolute top-0 left-0 w-full h-2 bg-[#FACC15]/20">
            <motion.div 
              initial={{ width: 0 }}
              animate={{ width: '100%' }}
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 focus:border-[#FACC15] outline-none transition-all text-white font-bold uppercase" 
              />
            </div>
            ...
            <button 
              ...
              className="w-full bg-[#FACC15] text-black py-6 rounded-2xl font-black uppercase italic text-xl hover:scale-[1.02] active:scale-95 transition-all shadow-[0_0_40px_rgba(250,204,21,0.2)]"
            >
              Submit Application
            </button>
          </div>
            ...
            >
              ...
              >
                ...
                <div className="flex gap-4">
                  ...
                  <button onClick={confirmOnboarding} className="flex-1 py-4 rounded-xl bg-[#FACC15] text-black font-black uppercase italic hover:scale-105 transition-all">I Agree</button>
                </div>
              </motion.div>
            </motion.div>
          )}
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                { label: 'Attendance', value: attendance.length > 0 ? `${Math.round((attendance.filter(a => a.status === 'present').length / 30) * 100)}%` : '0%', icon: Clock, color: 'text-[#FACC15]', bg: 'bg-[#FACC15]/10' },
                ...
                <motion.div 
                  ...
                  className="bg-slate-900/40 border border-white/5 rounded-3xl p-8 space-y-4 hover:border-[#FACC15]/30 transition-all group"
                >
            ...
            <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10">
              ...
              <div className="space-y-2 mb-8">
                ...
                <textarea 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 focus:border-[#FACC15] outline-none transition-all text-white font-bold uppercase h-32" 
                />
              </div>
              <button 
                onClick={handleLeaveSubmit}
                className="w-full bg-[#FACC15] text-black py-6 rounded-2xl font-black uppercase italic text-xl hover:scale-[1.02] active:scale-95 transition-all"
              >
                Submit Request
              </button>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10">
              <div className="flex justify-between items-center mb-8">
                ...
                <button 
                  ...
                  className="px-6 py-3 bg-[#FACC15] text-black rounded-xl font-black uppercase italic text-xs tracking-widest hover:scale-105 active:scale-95 transition-all disabled:opacity-50"
                >
              ...
              <div className="flex items-center gap-4 p-6 bg-white/5 rounded-2xl border border-white/5 text-left">
                <button 
                  ...
                  className={`w-8 h-8 rounded-lg border-2 flex items-center justify-center transition-all ${
                    resignAgreed ? 'bg-[#FACC15] border-[#FACC15] text-black' : 'border-white/20'
                  }`}
                >
            ...
            <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {projects.map((project, idx) => (
                  <div key={idx} className="p-8 bg-white/5 rounded-3xl border border-white/10 space-y-6 group hover:border-[#FACC15]/40 transition-all">
                    <div className="flex justify-between items-start">
                      <div className="w-14 h-14 bg-[#FACC15] rounded-2xl flex items-center justify-center text-black font-black text-xl italic shadow-[0_0_20px_rgba(250,204,21,0.1)]">
                    ...
                    <div className="pt-6 border-t border-white/5 flex justify-between items-center">
                      ...
                      <button className="text-[#FACC15] font-black uppercase italic text-xs tracking-widest flex items-center gap-2 group-hover:gap-4 transition-all">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 focus:border-[#FACC15] outline-none transition-all text-white font-bold uppercase h-40" 
                  />
                </div>
                <button 
                  onClick={handleUpdateSubmit}
                  disabled={!projectUpdate.projectId || !projectUpdate.details || isUpdating}
                  className="w-full bg-[#FACC15] text-black py-6 rounded-2xl font-black uppercase italic text-xl hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50"
                >
          ...
          {[
            ...
            <button
              ...
              className={`w-full flex items-center gap-4 px-6 py-4 rounded-2xl font-black uppercase italic text-xs tracking-widest transition-all duration-300 ${
                activeTab === tab.id 
                  ? 'bg-[#FACC15] text-black shadow-[0_0_30px_rgba(250,204,21,0.2)] scale-[1.02]' 
        ...
        <header className="px-12 py-10 flex justify-between items-center border-b border-white/5 bg-slate-900/20 backdrop-blur-md sticky top-0 z-30">
          ...
          <div className="flex items-center gap-6">
            <button 
              ...
              className="p-4 bg-[#FACC15]/10 text-[#FACC15] rounded-2xl hover:bg-[#FACC15] hover:text-black transition-all flex items-center gap-2 group"
            >
            ...
            <div className="text-right">
              ...
              <div className="text-[10px] font-black text-[#FACC15] uppercase tracking-widest">{profile?.status || 'Active'}</div>
            </div>
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#FACC15] to-yellow-600 flex items-center justify-center text-black font-black text-xl italic shadow-[0_0_30px_rgba(250,204,21,0.2)]">
