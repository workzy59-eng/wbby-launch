...
export default function Autos() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-[#c7c42a] selection:text-black">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 w-full z-50 px-10 py-8 flex justify-between items-center bg-gradient-to-b from-black/80 to-transparent backdrop-blur-sm">
        <div className="text-2xl font-black tracking-tighter uppercase italic">
          MERCEDES-<span className="text-[#c7c42a]">BENZ</span>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-10 w-full">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-[1px] bg-[#c7c42a]" />
              <span className="text-xs font-bold uppercase tracking-[0.4em] text-[#c7c42a]">AMG Performance</span>
            </div>
            <h1 className="text-8xl md:text-[10rem] font-black tracking-tighter leading-[0.8] uppercase italic mb-8">
              {CARS[currentCar].name.split(' ')[0]} <span className="text-[#c7c42a]">{CARS[currentCar].name.split(' ').slice(1).join(' ')}</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-6">
              <button className="px-12 py-6 bg-[#c7c42a] text-black rounded-2xl font-black uppercase italic text-xl hover:scale-105 transition-all shadow-[0_0_50px_rgba(199, 196, 42,0.3)]">
                Configure Yours
              </button>
              <div className="flex items-center gap-4 px-8 py-6 bg-white/5 border border-white/10 rounded-2xl">
                <div className="text-4xl font-black italic text-[#c7c42a] tabular-nums">{count}</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-12 bg-white/5 border border-white/10 rounded-[3rem] space-y-6 hover:border-[#c7c42a]/40 transition-all group">
                <div className="w-16 h-16 bg-[#c7c42a]/10 rounded-2xl flex items-center justify-center text-[#c7c42a] group-hover:bg-[#c7c42a] group-hover:text-black transition-all">
                  <f.icon size={32} />
                </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-10">
            <div className="flex items-center gap-3">
              <Users className="text-[#c7c42a]" size={32} />
              <span className="text-xs font-black uppercase tracking-[0.5em] text-[#c7c42a]">Our Team</span>
            </div>
            <h2 className="text-7xl font-black tracking-tighter uppercase italic leading-[0.9]">
              ENGINEERED TO <span className="text-[#c7c42a]">EXCITE</span>
            </h2>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4">
                  <div className="w-6 h-6 rounded-full bg-[#c7c42a] flex items-center justify-center text-black">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-10 -left-10 bg-[#c7c42a] p-12 rounded-[3rem] text-black shadow-2xl">
      ...
      <footer className="py-20 px-10 border-t border-white/10 text-center">
        ...
        <div className="flex justify-center gap-10 opacity-40">
          {['Instagram', 'Twitter', 'YouTube', 'LinkedIn'].map(s => (
            <a key={s} href="#" className="text-[10px] font-black uppercase tracking-widest hover:text-[#c7c42a] transition-all">{s}</a>
          ))}
        </div>
      </footer>
    </div>
