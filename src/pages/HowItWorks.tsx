      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-24">
          <div className="space-y-4">
            ...
            >
              How It <br />
              <span className="text-[#c7c42a]">Works.</span>
            </motion.h1>
          </div>
          <Link 
            to="/" 
          ...
          {STEPS.map((step, i) => (
            ...
            >
              <div className="flex-1 space-y-10">
                ...
                >
                  <div className="w-24 h-24 bg-[#c7c42a] rounded-[2.5rem] flex items-center justify-center text-black shadow-[0_0_50px_rgba(199,196,42,0.3)] group-hover:rotate-12 transition-transform duration-500">
                    <step.icon size={48} />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {step.details.map((detail, idx) => (
                    ...
                    >
                      <div className="w-8 h-8 rounded-full bg-[#c7c42a]/10 flex items-center justify-center text-[#c7c42a] group-hover:scale-110 transition-transform">
              ...
              >
                <div className="aspect-[4/3] bg-white/5 border border-white/10 rounded-[4rem] overflow-hidden relative group shadow-2xl">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#c7c42a]/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-1000 z-10" />
                  <motion.img 
                  ...
                  <div className="absolute bottom-10 left-10 z-20">
                    <div className="px-6 py-2 bg-black/60 backdrop-blur-xl border border-white/10 rounded-full text-[10px] font-black uppercase tracking-[0.3em] text-[#c7c42a]">
                      Phase 0{i + 1}
                    </div>
                  </div>
                </div>
        ...
        >
          <h2 className="text-5xl md:text-7xl font-black uppercase italic tracking-tighter leading-tight">
            ...
            <span className="text-[#c7c42a]">journey with us?</span>
          </h2>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link 
              to="/auth" 
              className="px-12 py-6 bg-[#c7c42a] text-black rounded-2xl font-black uppercase italic text-xl hover:scale-105 transition-all shadow-[0_0_50px_rgba(199,196,42,0.2)]"
            >
              Start Now
            </Link>
            <Link 
