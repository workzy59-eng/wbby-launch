...
export default function FoodCourt() {
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-sans selection:bg-[#E6FF00] selection:text-black overflow-x-hidden">
      {/* Navigation */}
      <nav className="flex items-center justify-between px-10 py-8 max-w-7xl mx-auto relative z-50">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-[#E6FF00] rounded-full flex items-center justify-center">
        ...
        <button className="px-8 py-3 rounded-full bg-[#E6FF00] text-black text-xs font-bold uppercase tracking-widest hover:scale-105 transition-all shadow-[0_0_30px_rgba(230,255,0,0.2)]">
          Order Now
        </button>
      </nav>
      ...
      <section className="relative pt-20 pb-32 px-10 max-w-7xl mx-auto min-h-[90vh] flex flex-col items-center justify-center">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#E6FF00]/5 rounded-full blur-[150px] -z-10" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-8 text-left">
            ...
            >
              <Star size={14} className="text-[#E6FF00]" />
            ...
            >
              ...
              <span className="text-[#E6FF00]">Food Specialties</span>
            </motion.h1>
            ...
            >
              <button className="bg-[#E6FF00] text-black px-10 py-5 rounded-2xl font-black text-lg uppercase italic flex items-center gap-3 hover:scale-105 transition-all">
              ...
              <div className="flex -space-x-4">
                ...
                <div className="w-12 h-12 rounded-full border-4 border-[#0A0A0A] bg-[#E6FF00] flex items-center justify-center text-black font-bold text-xs">
                  +2k
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-[#E6FF00] rounded-2xl flex items-center justify-center text-black">
                  <ShoppingBag size={24} />
                </div>
                <div>
      ...
      <section className="py-32 px-10 max-w-7xl mx-auto border-t border-white/5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="space-y-4">
            <div className="w-14 h-14 bg-[#E6FF00]/10 rounded-2xl flex items-center justify-center text-[#E6FF00]">
              <Clock size={28} />
            </div>
