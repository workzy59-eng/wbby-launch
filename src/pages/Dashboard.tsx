                      ...
                      <div className="p-6 bg-[#4A5D4E] rounded-3xl border border-white/5 flex items-center justify-between">
                        <div>
                          <div className="text-xl font-black uppercase italic text-[#E6FF00]">
                            {selectedProject.templateId === 'vanguard' ? 'Vanguard Realty' : 
                             selectedProject.templateId === 'autos' ? 'Global Autos' : 
                             selectedProject.templateId === 'fitpulse' ? 'FitPulse Gym' : 
                        ...
                        {['vanguard', 'autos', 'fitpulse'].includes(selectedProject.templateId) && (
                          <Link 
                            to={`/portfolio/${selectedProject.templateId === 'vanguard' ? 'vanguard' : selectedProject.templateId === 'autos' ? 'autos' : 'fitpulse'}`}
