      ...
      <aside className="fixed left-0 top-0 bottom-0 w-24 bg-black/20 backdrop-blur-3xl border-r border-white/5 flex flex-col items-center py-10 gap-10 z-40 hidden lg:flex">
        ...
        <nav className="flex-1 flex flex-col gap-6">
          ...
          {profile?.role === 'admin' && (
            <Link 
              to="/admin"
              className="p-4 rounded-2xl text-white/30 hover:text-[#FACC15] hover:bg-white/5 transition-all"
            >
              ...
              {activeTab === 'messages' ? (
                ...
                <div className="space-y-12">
                  <div className="flex flex-col gap-2">
                    <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[#FACC15]">Scheduling</span>
                ...
                <div className="bg-black/20 backdrop-blur-3xl rounded-[3rem] p-16 border border-white/5 shadow-2xl text-center space-y-8">
                  <div className="w-24 h-24 bg-[#FACC15] rounded-full flex items-center justify-center text-black mx-auto shadow-[0_0_50px_rgba(250,204,21,0.2)]">
                    <Settings size={48} />
                  </div>
                  <div className="space-y-4">
                    <h2 className="text-5xl font-black tracking-tighter uppercase italic text-[#FACC15]">Professional Settings</h2>
                  ...
                  <div className="pt-8">
                    <Link 
                      to="/settings" 
                      className="inline-block bg-[#FACC15] text-black px-12 py-5 rounded-full font-black text-xl uppercase italic hover:scale-[1.05] active:scale-[0.95] transition-all shadow-[0_0_30px_rgba(250,204,21,0.2)]"
                    >
                ...
                <div className="space-y-10">
                  <div className="flex flex-col md:flex-row justify-between items-end gap-6">
                    <div className="space-y-4">
                      <h2 className="text-xs font-black text-[#FACC15] uppercase tracking-[0.4em]">Billing & Subscription</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white/5 border border-white/10 p-10 rounded-[3rem] space-y-8 relative overflow-hidden group">
                      <div className="absolute top-0 right-0 w-32 h-32 bg-[#FACC15]/5 rounded-full blur-3xl -mr-16 -mt-16 group-hover:bg-[#FACC15]/10 transition-all" />
                      
                      <div className="flex justify-between items-start relative z-10">
                        <div className="space-y-1">
                          <div className="text-[10px] font-black uppercase tracking-widest text-[#FACC15]">Current Plan</div>
                        ...
                        <div className="px-4 py-1.5 bg-[#FACC15]/10 border border-[#FACC15]/20 rounded-full text-[10px] font-black uppercase tracking-widest text-[#FACC15]">
                          Active
                        </div>
                      </div>
                    ...
                    <div className="bg-white/5 border border-white/10 p-10 rounded-[3rem] space-y-8 flex flex-col justify-center text-center">
                      ...
                      <div className="pt-4">
                        <button className="text-[10px] font-black uppercase tracking-widest text-[#FACC15] hover:underline">
                        ...
                        <tbody className="divide-y divide-white/5">
                          {[
                            ...
                            <tr key={i} className="group hover:bg-white/5 transition-all">
                              ...
                              <td className="px-8 py-6 text-xs font-black text-[#FACC15] italic">{tx.amount}</td>
                ...
                <div className="space-y-10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                      { id: 'projects', label: 'Active Project', value: projects.filter(p => p.status === 'Development Started').length, icon: FolderKanban, color: 'text-yellow-400', bg: 'bg-yellow-400/10', items: projects.filter(p => p.status === 'Development Started').map(p => p.businessName) },
                      ...
                      { id: 'completed', label: 'Completed Projects', value: projects.filter(p => p.status === 'Completed').length, icon: CheckCircle2, color: 'text-yellow-400', bg: 'bg-yellow-400/10', items: projects.filter(p => p.status === 'Completed').map(p => p.businessName) },
                      { id: 'price', label: 'Plan Price', value: '1499/month', icon: PartyPopper, color: 'text-[#FACC15]', bg: 'bg-[#FACC15]/10', items: ['Basic Plan'] },
                    ].map((stat, i) => (
                      <div key={stat.id} className="relative">
                        <motion.button 
                          ...
                          className={`w-full bg-black/20 backdrop-blur-3xl p-8 rounded-[2.5rem] border border-white/5 shadow-xl group hover:border-[#FACC15]/30 transition-all text-left ${expandedBox === stat.id ? 'ring-2 ring-[#FACC15]/50' : ''}`}
                        >
                  ...
                  {projects.length === 0 ? (
                    <div className="bg-black/20 backdrop-blur-3xl rounded-[3rem] p-16 text-center border border-white/5 shadow-2xl">
                      <h2 className="text-5xl font-black tracking-tighter mb-6 uppercase italic text-[#FACC15]">No projects yet</h2>
                      <p className="text-white/60 mb-10 text-xl">Start your first project to see it here.</p>
                      <Link to="/onboarding" className="inline-block bg-[#FACC15] text-black px-12 py-5 rounded-full font-black text-xl uppercase italic hover:scale-[1.05] active:scale-[0.95] transition-all shadow-[0_0_30px_rgba(250,204,21,0.2)]">
                        Start Your Project
                      </Link>
                    </div>
                  ) : (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                      ...
                      <div className="lg:col-span-1 space-y-6">
                        <div className="flex items-center justify-between px-4">
                          ...
                          <Link to="/onboarding" className="text-[10px] font-black uppercase tracking-widest text-[#FACC15] hover:underline">New +</Link>
                        </div>
                        <div className="space-y-4">
                          {projects.map((p) => (
                            <div 
                        ...
                        {selectedProject && (
                          ...
                          >
                            ...
                            <div className="flex justify-between items-start mb-16 relative z-10">
                              <div>
                                <h2 className="text-6xl font-black tracking-tighter mb-4 uppercase italic text-[#FACC15]">Project Status</h2>
                                ...
                                <div className="mt-6 flex flex-wrap gap-4">
                                  <button 
                                    ...
                                    className="flex items-center gap-2 bg-[#FACC15]/10 border border-[#FACC15]/20 px-6 py-3 rounded-xl text-[#FACC15] hover:bg-[#FACC15] hover:text-black transition-all group"
                                  >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16 relative z-10">
                              <div className="space-y-6">
                                ...
                                <div className="p-6 bg-white/5 rounded-3xl border border-white/5 flex items-center justify-between">
                                  <div>
                                    <div className="text-xl font-black uppercase italic text-[#FACC15]">
                                  ...
                                  {['food-court', 'autos', 'clothing'].includes(selectedProject.templateId) && (
                                    <Link 
                                      ...
                                      className="bg-white/5 hover:bg-[#FACC15] hover:text-black p-3 rounded-xl transition-all"
                                    >
                                      <ArrowRight size={20} />
                                    </Link>
                                  )}
                            ...
                            <div className="space-y-12 mb-16 relative z-10">
                                  ...
                                  <div key={step} className="flex flex-col items-center min-w-[120px] text-center gap-4">
                                    <div className={`w-12 h-12 rounded-full flex items-center justify-center border-2 transition-all ${
                                      i < currentStepIndex 
                                        ...
                                        : i === currentStepIndex
                                          ? step === 'Declined' ? 'bg-red-500 border-red-500 text-white' : 'bg-[#FACC15] border-[#FACC15] text-black'
                                    ...
                                    <span className={`text-[10px] font-black uppercase tracking-widest ${
                                      i <= currentStepIndex ? step === 'Declined' ? 'text-red-500' : 'text-[#FACC15]' : 'text-white/20'
                                    }`}>
                                      {step}
                                    </span>
                                  </div>
                              ...
                              <div className="space-y-6">
                                <div className="flex justify-between items-end">
                                  <span className="text-2xl font-black uppercase italic text-[#FACC15]">Progress: {selectedProject.progress}%</span>
                                ...
                                <div className="w-full h-3 bg-white/5 rounded-full overflow-hidden p-0.5 border border-white/5">
                                  <motion.div 
                                    ...
                                    className="h-full bg-[#FACC15] rounded-full shadow-[0_0_15px_rgba(250,204,21,0.5)]"
                                  />
                                </div>
                              </div>
                            </div>
                      ...
                      <div id="dev-phase" className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                          ...
                          <div className="space-y-6">
                            {[
                              ...
                              <div key={i} className="flex gap-6 items-start">
                                <div className={`text-xl font-black italic ${phase.done ? 'text-[#FACC15]' : 'text-white/20'}`}>{phase.step}</div>
                                <div>
                        ...
                        <div className="bg-[#FACC15] p-10 rounded-[3rem] text-black flex flex-col justify-between shadow-[0_0_40px_rgba(250,204,21,0.1)]">
                          <div>
        ...
        {showCancelModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
            ...
            <motion.div 
              ...
              className="relative bg-black rounded-[3rem] p-12 max-w-md w-full text-center shadow-2xl border border-[#FFD700]/10"
            >
              <h3 className="text-4xl font-black tracking-tighter mb-6 uppercase italic text-[#FFD700]">Cancel Project?</h3>
