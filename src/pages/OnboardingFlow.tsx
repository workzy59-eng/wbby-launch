              ...
              <div className="flex gap-4">
                ...
                {user ? (
                  ...
                  <button 
                    ...
                    className="flex-1 bg-primary text-white py-6 rounded-2xl font-bold text-xl uppercase hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-primary/20"
                  >
                    Sign in to Continue
                  </button>
                )}
