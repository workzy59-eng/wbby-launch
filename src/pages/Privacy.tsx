    ...
    <div className="pt-40 pb-20 px-10">
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="space-y-6">
          ...
          <p className="text-white/40 text-sm font-bold uppercase tracking-widest">Last Updated: April 2, 2026</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-white/60 leading-relaxed">
          ...
          <section className="space-y-4">
            ...
            <p>If you have any questions about this privacy policy or our privacy practices, please contact us at: hello@webbylaunch.com</p>
          </section>
        </div>
      </div>
    </div>
