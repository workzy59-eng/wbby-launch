    ...
    <div className="bg-black min-h-screen">
      ...
      <section className="relative pt-40 pb-20 px-10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center space-y-8">
          ...
          >
            Web Development <br />
            <span className="text-[#E6FF00]">in {cityName}.</span>
          </motion.h1>
          ...
          >
            <Link 
              to="/auth"
              className="group bg-[#E6FF00] text-black px-10 py-5 rounded-2xl text-sm font-black uppercase tracking-widest hover:scale-105 transition-all shadow-[0_0_50px_rgba(230,255,0,0.3)] flex items-center gap-3"
            >
              Start Your Project
      ...
      <section className="py-32 px-10 bg-white/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <div key={i} className="bg-black/40 border border-white/10 p-12 rounded-[3rem] space-y-6 hover:border-[#E6FF00]/30 transition-all">
      ...
      <section className="py-32 px-10">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic">
            ...
            <span className="text-[#E6FF00]">Choose Webby Launch.</span>
          </h2>
      ...
      <section className="py-20 px-10 bg-[#E6FF00]">
