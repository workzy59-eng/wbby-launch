      ...
      <section className="relative pt-40 pb-20 px-10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center space-y-8">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-6 py-2 bg-white/5 border border-white/10 rounded-full text-[10px] font-black uppercase tracking-widest text-[#6366F1]"
          >
            Careers
          </motion.div>
          ...
          >
            Join the <br />
            <span className="text-[#6366F1]">WebbyLaunch Team.</span>
          </motion.h1>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          {roles.map((role, i) => (
            <motion.div
              ...
              className="group bg-white/5 border border-white/10 p-12 rounded-[3rem] space-y-8 hover:border-[#6366F1]/30 transition-all relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#6366F1]/5 blur-[80px] rounded-full translate-x-1/2 -translate-y-1/2 group-hover:bg-[#6366F1]/10 transition-all" />
              
              <div className="w-16 h-16 bg-[#6366F1]/10 rounded-2xl flex items-center justify-center text-[#6366F1]">
                <role.icon size={32} />
              </div>
              ...
              <Link 
                to={role.path}
                className="inline-flex items-center gap-3 bg-[#6366F1] text-white px-10 py-5 rounded-2xl text-sm font-black uppercase tracking-widest hover:scale-105 transition-all shadow-[0_0_50px_rgba(99,102,241,0.2)]"
              >
                Apply Now
                <ArrowRight size={18} />
              </Link>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-12">
          <div className="space-y-4">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic">
              Interview <span className="text-[#6366F1]">Process.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="space-y-4 p-8 bg-white/5 rounded-[2rem] border border-white/10">
                <div className="text-4xl font-black text-[#6366F1] italic">{s.step}</div>
