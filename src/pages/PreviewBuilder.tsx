...
export default function PreviewBuilder() {
  ...
  const [primaryColor, setPrimaryColor] = useState('#E6FF00');
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-sans selection:bg-[#E6FF00] selection:text-black flex flex-col lg:flex-row overflow-hidden">
      {/* Left Panel: Controls */}
      <div className="w-full lg:w-[400px] border-r border-white/10 bg-black/40 backdrop-blur-xl flex flex-col h-screen overflow-y-auto">
        <div className="p-8 border-b border-white/10 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#E6FF00] rounded-xl flex items-center justify-center text-black shadow-[0_0_20px_rgba(230,255,0,0.3)]">
              <Zap size={24} />
            </div>
            <h1 className="text-xl font-black uppercase italic tracking-tighter">Preview <span className="text-[#E6FF00]">Builder</span></h1>
          </div>
        ...
        <div className="p-8 space-y-10">
          ...
          <div className="space-y-4">
            ...
            <input 
              ...
              className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-sm font-bold focus:border-[#E6FF00]/50 outline-none transition-all"
            />
          </div>
          ...
          <div className="space-y-4">
            ...
            <div 
              ...
              className="w-full aspect-video bg-white/5 border-2 border-dashed border-white/10 rounded-3xl flex flex-col items-center justify-center gap-3 cursor-pointer hover:border-[#E6FF00]/30 transition-all group overflow-hidden relative"
            >
              {logo ? (
                <img src={logo} alt="Logo" className="w-full h-full object-contain p-4" />
              ) : (
                <>
                  <Upload className="text-white/20 group-hover:text-[#E6FF00] transition-colors" size={32} />
        ...
        <div className="mt-auto p-8 border-t border-white/10 bg-black/60">
          <button 
            ...
            className="w-full py-6 bg-[#E6FF00] text-black rounded-2xl font-black uppercase italic text-xl hover:scale-[1.02] active:scale-95 transition-all shadow-[0_0_40px_rgba(230,255,0,0.3)] flex items-center justify-center gap-4 group"
          >
      ...
      <div className="flex-1 bg-[#111] p-6 lg:p-12 flex flex-col items-center justify-center relative overflow-hidden">
        {/* Background Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#E6FF00]/5 rounded-full blur-[150px] pointer-events-none" />
        ...
        <div className="absolute top-8 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-black/40 backdrop-blur-xl border border-white/10 p-1.5 rounded-2xl z-50">
          <button 
            ...
            className={`p-3 rounded-xl transition-all ${viewMode === 'desktop' ? 'bg-[#E6FF00] text-black shadow-lg' : 'text-white/40 hover:text-white'}`}
          >
            <Monitor size={18} />
          </button>
          <button 
            onClick={() => setViewMode('mobile')}
            className={`p-3 rounded-xl transition-all ${viewMode === 'mobile' ? 'bg-[#E6FF00] text-black shadow-lg' : 'text-white/40 hover:text-white'}`}
          >
            <Smartphone size={18} />
          </button>
        </div>
        ...
        <div className="absolute bottom-12 right-12 z-[100]">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={handleBuildWebsite}
            className="flex items-center gap-4 px-8 py-4 bg-[#E6FF00] text-black rounded-full font-black text-sm uppercase italic shadow-[0_20px_40px_rgba(230,255,0,0.3)] border-4 border-black group"
          >
